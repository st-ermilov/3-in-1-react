...
import styles from '../../styles/components/weather_info.module.scss'
import axios from "axios";
import {setData, typeData} from "../../redux/slices/weatherSlice";
...
const WeatherInfo: React.FC<TProps> = ({id, cityName, data}) => {
    ...
    return (
        <div className={styles.container}>
            ...
            <h3>Temperature: {Math.round(data.main.temp - 273.15)}<sup>o</sup></h3>
